...
\subsection{Navigator pre-train}
...
It is also possible to integrate navigator pre-train phase to the main phase. In this setup, the navigator occasionally receives "return to the state" tasks from the state history buffer.
